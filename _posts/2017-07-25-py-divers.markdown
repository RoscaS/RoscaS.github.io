...
[Kevin London's blog](https://www.kevinlondon.com/2015/07/26/dangerous-python-functions.html)


## Compter des occurences

### Toutes les occurences dans une liste:
...
## Virtualenv + zsh
* [install on unbuntu](http://bicofino.io/2015/02/10/install-virtualenv-and-virtualenvwrapper-on-ubuntu-14-dot-04-2/)
...
### Exemple de nouveau venv pour openCV
...
# install usefull libs within this venv
...
* [install guide](https://www.learnopencv.com/install-opencv3-on-ubuntu/)
